...
<body class="font-sans antialiased bg-gray-100">
    <header class="w-full bg-white shadow mb-8">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <!-- Logo (optional) -->
                <!-- <img src="{{ asset('logo.png') }}" alt="Logo" class="h-10 w-10 rounded-full" /> -->
                <span class="text-xl font-bold text-black">Sitory</span>
            </div>
                    ...
                    <div class="absolute top-4 right-4 space-x-4">
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Log in</a>
                        @endauth
                    </div>
                @endif
            </nav>
    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="w-full max-w-4xl mb-8">
            <div class="mb-4">
                <form action="{{ route('welcome') }}" method="GET" class="flex flex-col sm:flex-row gap-2">
                    <input type="text" name="search_barang" value="{{ $searchBarang }}" placeholder="Cari barang..."
            ...
            <div class="overflow-x-auto bg-white rounded-lg shadow">
                <table class="min-w-full bg-white border border-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th
                                class="px-3 sm:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                No</th>
                            <th
                                class="px-3 sm:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Kategori</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($barangs as $barang)
                            <tr>
                                ...
                                <td class="px-3 sm:px-4 py-2 whitespace-nowrap text-sm">{{ $barang->kategori->name }}
                                </td>
                                <td class="px-3 sm:px-4 py-2 whitespace-nowrap text-sm">{{ $barang->name }}</td>
                                <td class="px-3 sm:px-4 py-2 whitespace-nowrap text-sm">Rp
        ...
        <div class="w-full max-w-4xl">
            <div class="mb-4">
                <form action="{{ route('welcome') }}" method="GET" class="flex flex-col sm:flex-row gap-2">
                    <input type="text" name="search_jasa" value="{{ $searchJasa }}" placeholder="Cari jasa..."
                        class="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <div class="flex gap-2">
                        <button type="submit"
                            class="w-full sm:w-auto bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Cari</button>
                        @if ($searchJasa)
                            <a href="{{ route('welcome', ['search_barang' => $searchBarang, 'barang_page' => request()->input('barang_page')]) }}"
                                class="w-full sm:w-auto bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600">Reset</a>
                        @endif
                    </div>
                </form>
    ...
    <footer class="w-full bg-white shadow mt-8 py-4">
        <div class="max-w-7xl mx-auto px-4 text-center text-gray-500 text-sm">
            &copy; {{ date('Y') }} Sitory. All rights reserved.
        </div>
    </footer>
</body>
